...
import ManagerAssignSeats from "@/components/ManagerAssignSeats.vue";
  ...
  methods: {
    ...
    async downloadCSVFile(floorId) {
      ...
      try {
        ...
        let contentDisposition = response.headers["content-disposition"]; // ���� �̸� //cors
        ...
        await axios
          ...
          .then((response) => {
            ...
            if (response.status === 206) {
              ...
              //failedObjectsList�� push�� ��ü���� �ִٸ� �׿� �´� errorMessage�����ϱ�
